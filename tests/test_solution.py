...
class TestDiagonalSudoku(unittest.TestCase):
    ...
    solved_diag_sudoku2_grid = '569142783243987165718653942971238456482576391356491278895324617627819534134765829'

    def test_solve(self):
        self.assertEqual(solution.solve(self.diagonal_grid), self.solved_diag_sudoku)

    def test_solve2(self):
        self.assertEqual(solution.solve(self.diagonal_grid2), grid2values(self.solved_diag_sudoku2_grid))
